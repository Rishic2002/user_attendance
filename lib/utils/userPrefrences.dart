...
class UserPrefrences {
  ...
  static var student = Student(
      studentEnrollmentNo: "191902",
      studentName: "Abhinay",
      studentemail: "191902@Student.com",
      semester: "V",
      batch: "B1",
      branch: "C.S.I.T.",
      studingInYear: "3rd",
  ...
  static List<Student> studentlist = [
    Student(
        studentEnrollmentNo: "191921",
        studentName: "Pawanesh",
        studentemail: "191921@Student.com",
        semester: "V",
        batch: "B1",
        branch: "C.S.I.T.",
        studingInYear: "3rd",
